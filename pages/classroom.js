      ...
      <div id="main">
        <div className='container-fluid'>
          ...
          <section className='page-contain row'>
            {!seen && enrolledClassrooms.length > 0 && enrolledClassrooms.map((classroom) => {
              return (
            ...
            {
              seen && option=="addClass" && <div className='mt-5'>
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" id="classSemester" placeholder="Fall 2022" onChange={(e) => setClassSemester(e.target.value)} />
                </div>
            ...
            {
              seen && option=="joinClass" && <div className='mt-5 pt-5'>
              <span className="close" onClick={togglePopup}> &times;    </span>
            ...
            {
              seen && option == "" && <div className='mt-5 pt-5'>
                <button className="btn btn-lg btn-orange col-12 m-5" onClick={() => setOption("addClass")}>Create a class</button>
                <button className="btn btn-lg btn-orange col-12 m-5" onClick={() => setOption("joinClass")}>Join a class</button>
              </div>
            }
          </section>
        </div>
