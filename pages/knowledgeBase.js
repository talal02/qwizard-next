    ...
    Aggregation: [
      {
        ...
        answer:
          "Aggregation is a special form of composition. It is a relationship between two classes that allows the child object to exist independently of the parent object. The child object has a reference to the parent object, but the parent object does not have a reference to the child object.",
      },
      {
    ...
    Association: [
      {
        ...
        answer:
          "Association is a relationship between two classes that allows one object instance to cause another to perform an action on its behalf. The association relationship is also known as a collaboration relationship.",
      },
      {
          ...
          <div className="col-sm-12 col-md-10 mt-4">
            ...
            >
              <ul style={{ "list-style-type": "none" }}>
                {questions[topic].map((question, idx) => (
                  <li className="m-3 p-3 border" key={`question-${idx}`}>
                    <div className="row">
        ...
        {selectedQuestion.length > 0 && (
          <div className="col-sm-12 col-md-10 mt-4">
            ...
            {showQuestion && (
              <ReactShadowScroll>
                <ul style={{ "list-style-type": "none" }}>
                  {selectedQuestion.map((question, idx) => (
                    <li className="m-3 p-3 border" key={`squestion-${idx}`}>
                      <div className="row">
                        <div className="col-10">
                          <p className="lead">{question["question"]}</p>
                        </div>
