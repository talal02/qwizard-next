...
function Login() {
    ...
    if (user && !loading) {
      const fetchUserData = async () => {
        ...
        if (!docSnap.exists()) {
          await setDoc(
            ref,
            new User(user.displayName, user.email, user.photoURL, [])
          );
          console.log("DONE!!!");
        }
      };
  ...
  return (
    ...
    <div className={styles.container}>
      <div className="row justify-content-center">
        <div
          className={`${styles.loginDiv} p-4 col-sm-10 col-md-8 col-lg-6 col-xl-4  rounded-div`}
        >
          <div className="d-flex justify-content-center">
            <Image
              src="/logo.svg"
          ...
          {loading && user ? (
            ...
            <section>
              <div className="d-flex">
                ...
                >
                  Qwizard is a Learning Management System (LMS) which
                  incorporates inside itself:
                  <br />
                  🌎Automatic Question Generation (Short Answer + MCQs)
                  <br />
                  🌎Automatic Solution (Answer) Generation
                  <br />
              ...
              <div className="d-flex mt-5 mb-3">
                <button
                  className={`${styles.btn} mx-auto btn`}
